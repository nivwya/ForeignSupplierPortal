  ...
  <div class="center-bg">
    <div class="main-box">
      ...
      <div class="login-section">
        ...
        @endif
        <form autocomplete="off" class="form-container" method="POST" action="{{ route('auth.handle') }}">
          @csrf
          <input type="hidden" name="mode" id="mode" value="{{ old('mode', $mode ?? 'login') }}">
          @if (old('mode', $mode ?? 'login') === 'login')
          <input autocomplete="username" type="text" name="vendor_id" placeholder="Vendor ID" required autofocus />
            <input autocomplete="new-password" type="password" name="password" placeholder="Password" required />
          ...
          @else
            <input  autocomplete="new-password" type="text" name="fullname" placeholder="Full Name" required autofocus />
            <input  autocomplete="new-password" type="email" name="email" placeholder="Email Address" required />
            <input  autocomplete="new-password" type="password" name="password" placeholder="Password" required />
...
function handleForgotPassword() {
    Swal.fire({
        ...
        preConfirm: (vendorId) => {
            ...
            .then(data => {
                if (!data.success) throw new Error(data.message || "Vendor ID not found");
