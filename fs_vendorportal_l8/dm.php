<div class="report-tabs" style="display:flex; flex-wrap:wrap; gap:12px; margin-bottom:20px;">
...
<div id="report-content-area">
  ...
  <div class="report-section" id="report-po-ack" style="display:none;">
    <div class="container mt-4">
      <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; color: #333; font-family: 'Inter', sans-serif;">
        <h3 style="color:#1c3e2c; font-weight:600; margin-bottom: 20px;">
  ...
  @endforeach
        ...
        <table style="width: 100%; border-collapse: collapse; background: white; font-size: 0.9rem; border: 1px solid #d4d4d4;">
...
<div class="report-section" id="report-payment" style="display:none;">
  <div class="container mt-4">
    <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; color: #333; font-family: 'Inter', sans-serif;">
      <h3 style="color:#1c3e2c; font-weight:600; margin-bottom: 20px;">Payment Status Report</h3>
...
<div class="report-section" id="report-dashboard" style="display:none;">
  <div class="container mt-4">
    <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; color: #333; font-family: 'Inter', sans-serif;">
      ...
      <ul style="background: #f9f9f9; border: 1px solid #d4d4d4; border-radius: 8px; padding: 20px; font-family: 'Inter', sans-serif; font-size: 0.95rem; margin-top: 20px; list-style: none;">
