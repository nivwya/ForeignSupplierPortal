...
Route::get('/orders-content', [App\Http\Controllers\OrderTabController::class, 'ordersTab'])
    ->middleware('auth');
Route::get('/orders-content', [App\Http\Controllers\OrderTabController::class, 'ordersTab'])->name('orders.tab');
...
Route::middleware(['web', 'auth:web'])->group(function () {
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('/admin/confirm-po-attachment', [App\Http\Controllers\Admin\DashboardController::class, 'confirmPOAttachment'])->name('admin.confirm-po-attachment');
